...
//            }
            .navigationDestination(isPresented: $projectVM.showEditor) {
                EditorView()
...
//                    )
//                } else {
//                    EditorView(showSubscription: $showSubscription, projects: $projects, input: nil)
//                }
            }
        }
//        .onAppear {
...
//            }
//        }
        .fullScreenCover(isPresented: $projectVM.showSubscription) {
            SubscriptionView()
        }
    }
